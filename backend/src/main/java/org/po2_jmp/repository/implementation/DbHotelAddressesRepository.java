...
public class DbHotelAddressesRepository implements HotelAddressesRepository {

    private final String url;
    private final String user;
    private final String password;

    public DbHotelAddressesRepository(String url, String user, String password) {
        if (areAnyNullParams(url, user, password)) {
            throw new IllegalArgumentException("Url, user and password can not be " +
                    "nulls but were passed to DbHotelAddressesRepository constructor");
        }
        this.url = url;
        this.user = user;
